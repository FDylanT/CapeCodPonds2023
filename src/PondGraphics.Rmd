...
ggsave("figures/svg/f1a.iii.svg", f1a.iii)
```
...
surf_list[[3]] <- surf_list[[3]] +
  scale_fill_gradientn(colors = parula(100), trans = "log10", name = expression(atop("Total Nitrogen", "(μg L"^-1*")")),
...
ggsave("figures/f1b.i.png", f1b.i, width = 6.5, height = 9, units = "in", dpi = 600)
