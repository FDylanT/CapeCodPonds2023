...
selectInput("param", label = "Choose parameter:", choices = colnames(allSurface)[c(14:20, 22:24)])
...
selectInput("param2", label = "Choose parameter:", choices = colnames(allBottom)[c(15:20, 22:24)])
...
```{r echo = FALSE}
selectInput("prop1", label = "Choose x parameter:", choices = c("Temp", "DO", "pH", "Alk", "TP", "TN", "Chla", "Phaeo"))
selectInput("prop2", label = "Choose y parameter:", choices = c("Temp", "DO", "pH", "Alk", "TP", "TN", "Chla", "Phaeo"))
...
selectInput("param3", label = "Choose parameter:", choices = c("Secchi", "Temp", "DO",   "DO_sat", "pH", "Alk", "TP", "TN", "Chla", "Phaeo"))
...
slopes_surf <- data.frame(rep(NA, length(pondName)),
                          ...
                          rep(NA, length(pondName)),
                          rep(NA, length(pondName)))
colnames(slopes_surf) <- c("pond", "Long", "Lat", colnames(allSurface)[c(13:20, 22:24)])
...
for(i in 1:length(pondName)) {
  ...
  for(param in colnames(allSurface)[c(13:20, 22:24)]) {
...
slopes_bott <- data.frame(rep(NA, length(pondName)),
                          ...
                          rep(NA, length(pondName)),
                          rep(NA, length(pondName)))
colnames(slopes_bott) <- c("pond", "Long", "Lat", colnames(allBottom)[c(15:20, 22:24)])
...
for(i in 1:length(pondName)) {
  ...
  for(param in colnames(allBottom)[c(15:20, 22:24)]) {
...
```{r echo = FALSE}
selectInput("param6", label = "Choose parameter:", choices = c("Secchi", "Temp", "DO", "DO_sat", "pH", "Alk", "TP", "TN", "Chla", "Phaeo"))
...
```{r echo = FALSE}
selectInput("param7", label = "Choose parameter:", choices = c("Temp", "DO", "DO_sat", "pH", "Alk", "TP", "TN", "Chla", "Phaeo"))
...
renderPlot({
  ggplot() +
    ...
    scale_fill_discrete(type = c("royalblue", "firebrick"), labels = c("negative", "positive"),
