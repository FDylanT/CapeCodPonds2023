...
```{r echo = FALSE}
selectInput("prop1", label = "Choose x parameter:", choices = c("Temp", "DO", "Alk", "TP", "TN", "Chla", "Phaeo"))
selectInput("prop2", label = "Choose y parameter:", choices = c("Temp", "DO", "Alk", "TP", "TN", "Chla", "Phaeo"))
...
renderPlot({
  ...
  ggplot(aes(x = get(input$prop1), y = get(input$prop2), col = BufferClass)) +
    ...
    theme_bw() +
    theme(panel.grid = element_blank())
    if(input$prop1 == "TP" | input$prop1 == "TN") {
      p <- p + scale_x_log10()
    }
    if(input$prop2 == "TP" | input$prop2 == "TN") {
      p <- p + scale_y_log10()
    }
...
selectInput("param3", label = "Choose parameter:", choices = c("Secchi", "Temp", "DO", "DO_sat", "Alk", "TP", "TN", "Chla", "Phaeo"))
...
sliderInput("year", label = "Year:", min = 2001, max = 2020, value = 2001)
...
```{r echo = FALSE}
selectInput("param6", label = "Choose parameter:", choices = c("Secchi", "Temp", "DO", "DO_sat", "Alk", "TP", "TN", "Chla", "Phaeo"))
...
```{r echo = FALSE}
selectInput("param7", label = "Choose parameter:", choices = c("Temp", "DO", "DO_sat", "Alk", "TP", "TN", "Chla", "Phaeo"))
