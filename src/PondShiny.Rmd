...
```{r echo = FALSE}
selectInput("prop1", label = "Choose x parameter:", choices = c("Temp", "DO", "Alk", "TP", "TN", "Chla"))
selectInput("prop2", label = "Choose y parameter:", choices = c("Temp", "DO", "Alk", "TP", "TN", "Chla"))
...
```{r echo = FALSE}
selectInput("prop3", label = "Choose x parameter:", choices = c("Temp", "DO", "Alk", "TP", "TN"))
selectInput("prop4", label = "Choose y parameter:", choices = c("Temp", "DO", "Alk", "TP", "TN"))
sliderInput("yearRange", label = "Year range:", min = 2001, max = 2023, value = c(2001, 2023))
```
...
selectInput("param3", label = "Choose parameter:", choices = c("Secchi", "Temp", "DO", "DO_sat", "Alk", "TP", "TN", "Chla"))
...
The region-wide anomaly values from a single year are visualized at once. Note that all months are included (but anything other than Aug/Sept should be NA -- will confirm).
